<div id="bootstrap-megamenu-admin" class="hidden bootstrap-megamenu-admin bootstrap-megamenu">
    ...
    <div class="bootstrap-megamenu-admin-mm-row clearfix">
      <div id="bootstrap-megamenu-admin-mm-bs">
        ...
        <div id="bootstrap-megamenu-admin-mm-intro" class="pull-left admin-toolbox">
          ...
          <ul>
            <li id="bootstrap-megamenu-style-wrapper" title="<?php print t('Select style for this megamenu');?>">
              <label class="hasTip"><?php print t('Style') ?></label>
              <fieldset class="btn-group">
                <div class="controls bootstrap-controls">
                  <select name="bootstrap-megamenu-style">
                    <?php print $style_options;?>
                  </select>
                </div>
              </fieldset>
            </li>
            <li id="bootstrap-megamenu-animation-wrapper" title="<?php print t('Select animation for this megamenu - CSS3 Animation');?>">
              <label class="hasTip"><?php print t('Animation') ?></label>
              <fieldset class="btn-group">
                <div class="controls bootstrap-controls">
                  <select name="bootstrap-megamenu-animation">
                    <?php print $animation_options;?>
                  </select>
                </div>
              </fieldset>
            </li>
            <li id="bootstrap-megamenu-delay-wrapper" style="display: <?php print $block_config['animation'] == 'none' ? 'none' : 'inline-block';?>;" title="<?php print t('Delay time of the animation - this field must be an integer.');?>">
              <label class="hasTip"><?php print t('Delay (ms)') ?></label>
              <fieldset class="btn-group">
                <div class="controls bootstrap-controls">
                  <input class="input-medium toolitem-delay toolbox-input" name="bootstrap-megamenu-delay" type="text" value="<?php print $block_config['delay'];?>" data-name="delay"></input>
                </div>
              </fieldset>
            </li>
            <li id="bootstrap-megamenu-duration-wrapper" style="display: <?php print $block_config['animation'] == 'none' ? 'none' : 'inline-block';?>;" title="<?php print t('Duration of the animation - this field must be an integer.');?>">
              <label class="hasTip"><?php print t('Duration (ms)') ?></label>
              <fieldset class="btn-group">
                <div class="controls bootstrap-controls">
                  <input class="input-medium toolitem-duration toolbox-input" name="bootstrap-megamenu-duration" type="text" value="<?php print $block_config['duration'];?>" data-name="duration"></input>
                </div>
              </fieldset>
            </li>
            <li>
              ...
              <fieldset class="radio btn-group toolitem-auto-arrow" data-auto-arrow="<?php print $block_config['auto-arrow'];?>">
                <input type="radio" <?php print $block_config['auto-arrow'] ? '' : 'checked="checked"';?> value="0" name="bootstrap-megamenu-auto-arrow" data-action="toggleAutoArrow" class="toolbox-toggle" id="toggleAutoArrow0">
                ...
                <input type="radio" <?php print $block_config['auto-arrow'] ? 'checked="checked"' : '';?> value="1" name="bootstrap-megamenu-auto-arrow" data-action="toggleAutoArrow" class="toolbox-toggle" id="toggleAutoArrow1">
            ...
            <li>
              ...
              <fieldset class="radio btn-group toolitem-always-show-submenu" data-always-show-submenu="<?php print $block_config['always-show-submenu'];?>">
                <input type="radio" <?php print $block_config['always-show-submenu'] ? '' : 'checked="checked"';?> value="0" name="bootstrap-megamenu-always-show-submenu" data-action="toggleAlwayShowSubmenu" class="toolbox-toggle" id="toggleAlwayShowSubmenu0">
                ...
                <input type="radio" <?php print $block_config['always-show-submenu'] ? 'checked="checked"' : '';?> value="1" name="bootstrap-megamenu-always-show-submenu" data-action="toggleAlwayShowSubmenu" class="toolbox-toggle" id="toggleAlwayShowSubmenu1">
  ...
  <div id="bootstrap-megamenu-admin-mm-container" class="navbar clearfix">
