<div id="bootstrap-megamenu-admin-mm-toolcol" class="admin-toolbox">
  ...
  <ul>
    <li id="bootstrap-megamenu-block-wrapper" title="<?php print t('Blocks') . ' - ' . t('Add/replace a block to the selected column') ?>">
